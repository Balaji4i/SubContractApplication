...
public class MailHtmlBody {
    ...
    public static String submit(String nameOfNofication, String NoficationNumber, String LoginUser){
        ...
        "<p style=\"margin:0; font-size:12px; line-height:14px; text-align:center\"><a href=\"mailto:omniyatnotifications@omniyat-me.com?subject=Order+Notifications+Support+(12001)\" target=\"_blank\" rel=\"noopener noreferrer\" title=\"omniyatnotification@gmail.com\" style=\"color:#ffffff; text-decoration:underline\"><wbr></a></p>\n" + 
        "</div>\n" + 
        "</div>\n" + 
        "</td>\n" + 
        "</tr>\n" + 
