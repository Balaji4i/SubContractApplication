...
//                                   totalNumberofRows);
                if (skipcnt == 1) {
                    ...
                    //System.err.println("COLUMN======columnCount======="+columnCount);
                }
                if (skipcnt > skipRw) {
...
//                                                   numOfItem);
                                ...
                                //System.err.println("===price====" + priceUnit);
                            ...
                            //                            }
                                ...
                                //System.err.println("===st====" + startDate);
                            } else if (Index == 7) {
                                if (MytempCell != null) {
...
//                                                   projectNumber);
                                ...
                                //System.err.println("===task====" + taskNumber +
//                                                   "==IN==" + Index);
                              }
                            //                            else if (Index == 10) {
                            //                                if (MytempCell != null) {
                            ...
                            //                             }
                                ...
                                if (MytempCell != null) {
                                    ...
                                    case 0:
                                        double taxc =
                                            MytempCell.getNumericCellValue();
                                        taxCode = Integer.toString((int)taxc);
                                        break;
                                    }
                                } else {
                                    taxCode = null;
                                ...
                                ProcessRow(lineNumber, itemName,
                                           ...
                                           numOfItem, priceUnit, lineAmount,
