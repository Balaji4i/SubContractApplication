...
public class FileAttachment {
    ...
    public static String TableFileToDB(UploadedFile file, ViewObject vo) {
                ...
                if (myfile != null) {
                    filename = myfile.getFilename();
                    if (myfile.getContentType().equalsIgnoreCase("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet") ||
                        myfile.getContentType().equalsIgnoreCase("application/xlsx")){
                        ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    }
                    else if(myfile.getContentType().equalsIgnoreCase("application/vnd.openxmlformats-officedocument.wordprocessingml.document")) {
                    ...
                    vo.getCurrentRow().setAttribute("Attachment", createBlobDomain(myfile));
                    vo.executeQuery();
                }
                return null;
            }
        ...
        public static void downloadFileListener(FacesContext facesContext, OutputStream outputStream, ViewObject vo) {
                String attachId =  vo.getCurrentRow().getAttribute("AttachId")==null?"0":vo.getCurrentRow().getAttribute("AttachId").toString();
