...
//                                   "=====balamount==" + balamount);
                ...
                retRelRow.setAttribute("OrgId", orgId);
//                --------------
                retRelRow.setAttribute("Attribute1", invoiceAmount.toString());
                retRelRow.setAttribute("Attribute2", releasedAmount.toString());
                retRelRow.setAttribute("Attribute3", balamount.toString());
//                -------
//                retRelRow.setAttribute("invoice_amountTrans", invoiceAmount);
