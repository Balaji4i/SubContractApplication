...
public class contrSearch {
    ...
    ViewObject conSearchHdrVO = ADFUtils.findIterator("contractROVO1Iterator").getViewObject();
    ViewObject conHistoryHdrVO = ADFUtils.findIterator("contract_HistoryROVO1Iterator").getViewObject();
    
    ViewObject variationConHdrVO = ADFUtils.findIterator("variationSearchROVO1Iterator").getViewObject();
    
    ViewObject applicationSearchHdrVO = ADFUtils.findIterator("applicationSearchROVO1Iterator").getViewObject();
    ViewObject applicationHistoryHdrVO = ADFUtils.findIterator("applicationHistory_ROVO1Iterator").getViewObject();
    ...
    ViewObject contRetSearchHdrVO = ADFUtils.findIterator("searchRetReleaseROVO1Iterator").getViewObject();
    ...
    public String onClickVariation() throws SQLException {
        ...
        if(ADFContext.getCurrent().getSessionScope().get("page").equals("buy")){
            if(conSearchHdrVO.getEstimatedRowCount()!=0){
                String headerID = (String)conSearchHdrVO.getCurrentRow().getAttribute("ContHeaderId").toString();
                //System.err.println("==headerID=="+headerID);
                String version = (String)conSearchHdrVO.getCurrentRow().getAttribute("Version").toString();
            ...
            if(variationConHdrVO.getEstimatedRowCount()!=0){
                String headerID = (String)variationConHdrVO.getCurrentRow().getAttribute("ContHeaderId").toString();
                //System.err.println("==headerID=="+headerID);
                String version = (String)variationConHdrVO.getCurrentRow().getAttribute("Version").toString();
                //System.err.println("==version=="+version); 
                flag= onCallVaration(headerID, version);
            }
        }else{
...
//           JSFUtils.addFacesInformationMessage("Flag"+errorMessage);
        ...
        if(ADFContext.getCurrent().getSessionScope().get("page").toString().equalsIgnoreCase("buy")||
           ADFContext.getCurrent().getSessionScope().get("page").toString().equalsIgnoreCase("sell")){
            if(conSearchHdrVO.getEstimatedRowCount()!=0){
                ...
                RichPopup pop = getP1();
                pop.show(hints);
                String headerNum = conSearchHdrVO.getCurrentRow().getAttribute("ContractNum").toString();
               ...
               BigDecimal totalSum=calculateTotalSum(conHistoryHdrVO, "ContractAmount"); 
               //System.err.println("==Total Sum=="+totalSum);
               ADFContext.getCurrent().getSessionScope().put("totalSum", totalSum);
            }
            ...
            if(variationConHdrVO.getEstimatedRowCount()!=0){
                ...
                RichPopup pop = getP1();
                pop.show(hints);
                String headerNum = variationConHdrVO.getCurrentRow().getAttribute("ContractNum").toString();
                ViewCriteria vc  = conHistoryHdrVO.createViewCriteria();
                ViewCriteriaRow vcr =  vc.createViewCriteriaRow();
                vcr.setAttribute("ContractNum", headerNum);
                vc.addRow(vcr);
        ...
        if(ADFContext.getCurrent().getSessionScope().get("page").toString().equalsIgnoreCase("buy")||
           ADFContext.getCurrent().getSessionScope().get("page").toString().equalsIgnoreCase("sell")){
            if(conSearchHdrVO.getEstimatedRowCount()!=0){
                ...
                RichPopup pop = getP2();
                pop.show(hints);  
                String contractID = conSearchHdrVO.getCurrentRow().getAttribute("ContHeaderId").toString();
            ...
            if(variationConHdrVO.getEstimatedRowCount()!=0){
                ...
                RichPopup pop = getP2();
                pop.show(hints);  
                String contractID = variationConHdrVO.getCurrentRow().getAttribute("ContHeaderId").toString();
                // Filter in certification History ROVO- contract Id
                ViewCriteria vc  = certificationHistoryHdrVO.createViewCriteria();
                ViewCriteriaRow vcr =  vc.createViewCriteriaRow();
                vcr.setAttribute("ContHeaderId", contractID);
    ...
    public void onClickApplicationSearch(ActionEvent actionEvent) {
        if(appInputText.getValue()!=null){
            ...
            ViewCriteriaRow vcr =  vc.createViewCriteriaRow();
            vcr.setAttribute("ApplicationNumber", "like %"+appInputText.getValue()+"%");
            vc.addRow(vcr);
    ...
    public void onClickCertificationSearch(ActionEvent actionEvent) {
        if(certInputText.getValue()!=null){
            ...
            ViewCriteriaRow vcr =  vc.createViewCriteriaRow();
            vcr.setAttribute("CertificationNumber", "like %"+certInputText.getValue()+"%");
            vc.addRow(vcr);
    ...
    public void onClickContractVariationSearch(ActionEvent actionEvent) {
        if(variationInputText.getValue()!=null){
            ...
            ViewCriteriaRow vcr =  vc.createViewCriteriaRow();
            vcr.setAttribute("ContractNum", "like %"+variationInputText.getValue()+"%");
            vc.addRow(vcr);
    ...
    public void createPOACL(ActionEvent actionEvent) {
        ViewObject srchVO = ADFUtils.findIterator("applicationSearchROVO1Iterator").getViewObject();
        ViewObject contHdrVO =ADFUtils.findIterator("XxscContractHeadersVO1Iterator").getViewObject();
        ViewObjectImpl contHdrImpl = (ViewObjectImpl)contHdrVO.getViewObject();
        ViewObject contDtlVO =ADFUtils.findIterator("XxscContractLinesVO1Iterator").getViewObject();
    
        contHdrVO.setNamedWhereClauseParam("BV_ID", srchVO.getCurrentRow().getAttribute("ContHeaderId"));
        contHdrVO.setNamedWhereClauseParam("BV_VER", srchVO.getCurrentRow().getAttribute("Version"));
    ...
    public void onClickBuyApplicationSearch(ActionEvent actionEvent) {
        if(buyAppInputText.getValue()!=null){
            ViewCriteria vc  = applicationSearchHdrVO.createViewCriteria();
            ViewCriteriaRow vcr =  vc.createViewCriteriaRow();
            vcr.setAttribute("ApplicationNumber", "like %"+buyAppInputText.getValue()+"%");
            vc.addRow(vcr);
            applicationSearchHdrVO.applyViewCriteria(vc);
            applicationSearchHdrVO.executeQuery();
    ...
    public BigDecimal calculateTotalSum(ViewObject vo, String sumColumnName){
     ...
     while(rs.hasNext()){
         Row r=rs.next();
         double sum = r.getAttribute(sumColumnName)==null?0:Double.parseDouble(r.getAttribute(sumColumnName).toString());  
       total=total+sum;
     }
           ...
           ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
            // Contract- Buy 
             ...
             AdfFacesContext.getCurrentInstance().addPartialTarget(t3);            
                     ...
                     ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
             // Certification- Buy
            filterTableCert(certificationSearchHdrVO, "CertificationNumber", "", "B");
            AdfFacesContext.getCurrentInstance().addPartialTarget(t3);             
         }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("certificationSell")&& 
                              ADFContext.getCurrent().getSessionScope().get("intent").equals("S")){
              // Certification- Sell
              filterTable(certificationSearchHdrVO, "CertificationNumber", "", "S");
              AdfFacesContext.getCurrentInstance().addPartialTarget(t3);             
           ...
           ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
            // Contract- Buy 
             ...
             AdfFacesContext.getCurrentInstance().addPartialTarget(t1);           
                     ...
                     ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
             // Application- Buy
             filterTable(applicationSearchHdrVO, "ApprovalStatusAppl", "PEN", "B");
             AdfFacesContext.getCurrentInstance().addPartialTarget(t3);
         }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("application")&& 
                     ADFContext.getCurrent().getSessionScope().get("intent").equals("S")){
             // Application- Sell
             filterTable(applicationSearchHdrVO, "ApprovalStatusAppl", "PEN", "S");
             AdfFacesContext.getCurrentInstance().addPartialTarget(t3);            
         }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("certificationBuy")&& 
                     ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
             // Certification- Buy
            filterTableCert(certificationSearchHdrVO, "ApprovalStatusCert", "PEN", "B");
            AdfFacesContext.getCurrentInstance().addPartialTarget(t3);             
         }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("certificationSell")&& 
                              ADFContext.getCurrent().getSessionScope().get("intent").equals("S")){
              // Certification- Sell
              filterTable(certificationSearchHdrVO, "ApprovalStatusCert", "PEN", "S");
              AdfFacesContext.getCurrentInstance().addPartialTarget(t3);             
          }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("retentionBuy")&& 
                   ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
               //Retention- Buy
           ...
           ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
            // Contract- Buy 
             ...
             AdfFacesContext.getCurrentInstance().addPartialTarget(t1);           
                     ...
                     ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
             // Application- Buy
             filterTable(applicationSearchHdrVO, "ApprovalStatusAppl", "APR", "B");
             AdfFacesContext.getCurrentInstance().addPartialTarget(t3);
         }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("application")&& 
                     ADFContext.getCurrent().getSessionScope().get("intent").equals("S")){
             // Application- Sell
             filterTable(applicationSearchHdrVO, "ApprovalStatusAppl", "APR", "S");
             AdfFacesContext.getCurrentInstance().addPartialTarget(t3);            
         }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("certificationBuy")&& 
                     ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
             // Certification- Buy
            filterTableCert(certificationSearchHdrVO, "ApprovalStatusCert", "APR", "B");
            AdfFacesContext.getCurrentInstance().addPartialTarget(t3);             
         }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("certificationSell")&& 
                              ADFContext.getCurrent().getSessionScope().get("intent").equals("S")){
              // Certification- Sell
              filterTable(certificationSearchHdrVO, "ApprovalStatusCert", "APR", "S");
              AdfFacesContext.getCurrentInstance().addPartialTarget(t3);             
          }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("retentionBuy")&& 
                   ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
               //Retention- Buy
               ...
               ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
                // Contract- Buy 
                 ...
                 AdfFacesContext.getCurrentInstance().addPartialTarget(t1);           
                         ...
                         ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
                 // Application- Buy
                 filterTable(applicationSearchHdrVO, "ApprovalStatusAppl", "REJ", "B");
                 AdfFacesContext.getCurrentInstance().addPartialTarget(t3);
             }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("application")&& 
                         ADFContext.getCurrent().getSessionScope().get("intent").equals("S")){
                 // Application- Sell
                 filterTable(applicationSearchHdrVO, "ApprovalStatusAppl", "REJ", "S");
                 AdfFacesContext.getCurrentInstance().addPartialTarget(t3);            
             }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("certificationBuy")&& 
                         ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
                 // Certification- Buy
                filterTableCert(certificationSearchHdrVO, "ApprovalStatusCert", "REJ", "B");
                AdfFacesContext.getCurrentInstance().addPartialTarget(t3);             
             }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("certificationSell")&& 
                                  ADFContext.getCurrent().getSessionScope().get("intent").equals("S")){
                  // Certification- Sell
                  filterTable(certificationSearchHdrVO, "ApprovalStatusCert", "REJ", "S");
                  AdfFacesContext.getCurrentInstance().addPartialTarget(t3);             
              }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("retentionBuy")&& 
                   ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
               //Retention- Buy
               ...
               ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
                // Contract- Buy 
                 ...
                 AdfFacesContext.getCurrentInstance().addPartialTarget(t1);           
                         ...
                         ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
                 // Application- Buy
                 filterTable(applicationSearchHdrVO, "ApplicationStatus", "ACTIVE", "B");
                 AdfFacesContext.getCurrentInstance().addPartialTarget(t3);
             }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("application")&& 
                         ADFContext.getCurrent().getSessionScope().get("intent").equals("S")){
                 // Application- Sell
                 filterTable(applicationSearchHdrVO, "ApplicationStatus", "ACTIVE", "S");
                 AdfFacesContext.getCurrentInstance().addPartialTarget(t3);            
             }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("certificationBuy")&& 
                         ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
                 // Certification- Buy
                filterTableCert(certificationSearchHdrVO, "CertificationStatus", "ACTIVE", "B");
                AdfFacesContext.getCurrentInstance().addPartialTarget(t3);             
             }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("certificationSell")&& 
                                  ADFContext.getCurrent().getSessionScope().get("intent").equals("S")){
                  // Certification- Sell
                  filterTable(certificationSearchHdrVO, "CertificationStatus", "ACTIVE", "S");
                  AdfFacesContext.getCurrentInstance().addPartialTarget(t3);             
              }else if(ADFContext.getCurrent().getSessionScope().get("page").equals("retentionBuy")&& 
                   ADFContext.getCurrent().getSessionScope().get("intent").equals("B")){
               //Retention- Buy
    ...
    public void filterTable(ViewObject vo, String columnName, String value, String IntentValue){
    ...
    //only for buy cert
    public void filterTableCert(ViewObject vo, String columnName, String value, String IntentValue){
        ViewCriteria vc  = vo.createViewCriteria();
        ViewCriteriaRow vcr =  vc.createViewCriteriaRow();
        vcr.setAttribute(columnName, value);
        vcr.setAttribute("Intent", IntentValue);
        vc.addRow(vcr);
        vo.applyViewCriteria(vc);
        vo.setSortBy("CertHeaderId desc");
        vo.setQueryMode(ViewObject.QUERY_MODE_SCAN_DATABASE_TABLES);
        vo.executeQuery();
        
    }
    //filter my pending for cert
    public void filterMyTable(ViewObject vo, String columnName, String value, String IntentValue, String flowWith){
        ViewCriteria vc  = vo.createViewCriteria();
        ViewCriteriaRow vcr =  vc.createViewCriteriaRow();
        vcr.setAttribute(columnName, value);
        vcr.setAttribute("Intent", IntentValue);
        vcr.setAttribute("FlowWith", flowWith);
        vc.addRow(vcr);
        vo.applyViewCriteria(vc);
...
//                               e.toString());
    ...
    public void onClickPDF(javax.faces.context.FacesContext facesContext,
                ...
                ViewObject vo =Utils.ADFUtils.findIterator("contractROVO1Iterator").getViewObject();
               Number contID =(Number)vo.getCurrentRow().getAttribute("ContHeaderId");
               Object result = RTFUtils.runReport(("//reports//Contract Summary.rtf"), contID, "contract_summary1");
//                Object result = runReport("//reports//Contract Summary.rtf");
    ...
    public void onClickDelete(ActionEvent actionEvent) throws SQLException {
        ViewObject conSearchHdrVO = ADFUtils.findIterator("contractROVO1Iterator").getViewObject();
        Object hid=(Object)conSearchHdrVO.getCurrentRow().getAttribute("ContHeaderId").toString();
        String status=conSearchHdrVO.getCurrentRow().getAttribute("ApprovalStatus")==null?"":conSearchHdrVO.getCurrentRow().getAttribute("ApprovalStatus").toString();
        if(status.equalsIgnoreCase("DRA")){
            hid=conSearchHdrVO.getCurrentRow().getAttribute("ContHeaderId").toString();
            oracle.jbo.domain.Number headerID=new oracle.jbo.domain.Number(hid.toString());
            //System.err.println("=---headID----"+headerID);
            String msg = null;
            ApplicationModuleImpl am=(ApplicationModuleImpl)ADFUtils.getApplicationModuleForDataControl(null); 
            dobProcArgs = new Object[][]{ { "IN", headerID, OracleTypes.NUMBER }, //0
                       ...
                       try {
                           ...
                           DBUtils.callDBStoredProcedure(am.getDBTransaction(),
                                                     "call xxsc_contract_pkg .purge_Contract(?,?)",dobProcArgs);
    ...
    public void onClickFcr(ActionEvent actionEvent) throws IOException {
//        
        Object projectid=JSFUtils.resolveExpression("#{bindings.projectid.inputValue}");
        Object date=JSFUtils.resolveExpression("#{bindings.Dates.inputValue}");
//        
//        Desktop d=Desktop.getDesktop();
//
//        try {
//            d.browse(new URI("http://144.21.82.205/OmniyatFcrReport1/webresources/fcrservice/fcrReport?p_project_id="+projectid+"&p_date="+date+"&P_File_Type=xlsx"));
...
//    public String getCallurlmethod()
//    {
//        Object projectid=JSFUtils.resolveExpression("#{bindings.projectid.inputValue}");
//        Object date=JSFUtils.resolveExpression("#{bindings.Dates.inputValue}");
//       
//        return "http://144.21.82.205/OmniyatFcrReport1/webresources/fcrservice/fcrReport?p_project_id="+projectid+"&p_date="+date+"&P_File_Type=xlsx";
//    }

    public void onClickMyPending(ActionEvent actionEvent) {
            ...
            ViewObject userVO = ADFUtils.findIterator("XxscUserAccess1Iterator").getViewObject();
            ...
            userVO.executeQuery();
             ...
             filterMyTable(certificationSearchHdrVO, "ApprovalStatusCert", "PEN", "B",loginID);
             AdfFacesContext.getCurrentInstance().addPartialTarget(t3);
         }
    }
}
