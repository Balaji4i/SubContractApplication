...
// ---------------------------------------------------------------------
public class payCertAMImpl extends ApplicationModuleImpl {
    /**
    ...
    public void createNewCertification(){
        ...
        //System.err.println("===" +ADFContext.getCurrent().getSessionScope().get("appID"));
        ...
        certificaHrdRow.setAttribute("ApplHeaderId", ADFContext.getCurrent().getSessionScope().get("appID"));
        ...
        applLineVCR.setAttribute("ApplHeaderId", ADFContext.getCurrent().getSessionScope().get("appID"));
        applLineVCR.setAttribute("ContHeaderId", ADFContext.getCurrent().getSessionScope().get("contHdrID"));
        applLineVC.addRow(applLineVCR);
        applLineVO.applyViewCriteria(applLineVC);
        applLineVO.executeQuery();
        //System.out.println("App Line Count=="+applLineVO.getEstimatedRowCount());
        ...
        while(rs.hasNext()){
            ...
            certificaLineRow.setAttribute("ContLineId", appLineRow.getAttribute("ContLineId"));
            certificaLineRow.setAttribute("Version", appLineRow.getAttribute("Version"));
            certificaLineRow.setAttribute("ApplLineId", appLineRow.getAttribute("ApplLineId"));
            certificaLineRow.setAttribute("ApplHeaderId", appLineRow.getAttribute("ApplHeaderId"));
            certificaLineRow.setAttribute("DataSetId", appLineRow.getAttribute("DataSetId"));
            certificaLineRow.setAttribute("ContractHeaderId", appLineRow.getAttribute("ContHeaderId"));
            certificaLineRow.setAttribute("OrgId", appLineRow.getAttribute("OrgId"));
            
            certificaLineRow.setAttribute("Trans_ConLine_ItemDesc", appLineRow.getAttribute("Trans_Item"));
            certificaLineRow.setAttribute("Trans_ConLine_UOM", appLineRow.getAttribute("Trans_Uom"));
            certificaLineRow.setAttribute("Trans_ConLine_QTY", appLineRow.getAttribute("Trans_Qty"));
            certificaLineRow.setAttribute("Trans_ConLine_Rate", appLineRow.getAttribute("Trans_Rate"));
            certificaLineRow.setAttribute("Trans_ConLine_Amount", appLineRow.getAttribute("Trans_Amount"));
            
            
            certificaLineRow.setAttribute("PrevPerc", appLineRow.getAttribute("PrevPerc"));
            certificaLineRow.setAttribute("PrevSupOnlyQty", appLineRow.getAttribute("PrevSupOnlyQty"));
            certificaLineRow.setAttribute("PrevSupInsQty", appLineRow.getAttribute("PrevSupInsQty"));
            certificaLineRow.setAttribute("PrevTotQty", appLineRow.getAttribute("PrevTotQty"));
            certificaLineRow.setAttribute("PrevAmount", appLineRow.getAttribute("PrevAmount"));
...
//            certificaLineRow.setAttribute("CurrAmount", appLineRow.getAttribute(""));
            ...
            certificaLineRow.setAttribute("CumPerc", appLineRow.getAttribute("CumPerc"));
            certificaLineRow.setAttribute("CumSupOnlyQty", appLineRow.getAttribute("CumSupOnlyQty"));
            certificaLineRow.setAttribute("CumSupInsQty", appLineRow.getAttribute("CumSupInsQty"));
            certificaLineRow.setAttribute("CumTotQty", appLineRow.getAttribute("CumTotQty"));
            certificaLineRow.setAttribute("CumAmount", appLineRow.getAttribute("CumAmount"));
            
            certificaLineRow.setAttribute("PrevPerc_Trans", appLineRow.getAttribute("PrevPerc"));
            certificaLineRow.setAttribute("PrevSupOnlyQty_Trans", appLineRow.getAttribute("PrevSupOnlyQty"));
            certificaLineRow.setAttribute("PrevSupInsQty_Trans", appLineRow.getAttribute("PrevSupInsQty"));
            certificaLineRow.setAttribute("PrevTotQty_Trans", appLineRow.getAttribute("PrevTotQty"));
            certificaLineRow.setAttribute("PrevAmount_Trans", appLineRow.getAttribute("PrevAmount"));
            
            certificaLineRow.setAttribute("CurrPerc_Trans", appLineRow.getAttribute("CurrPerc"));
            certificaLineRow.setAttribute("CurrSupOnlyQty_Trans", appLineRow.getAttribute("CurrSupOnlyQty"));
            certificaLineRow.setAttribute("CurrSupInsQty_Trans", appLineRow.getAttribute("CurrSupInsQty"));
            certificaLineRow.setAttribute("CurrTotQty_Trans", appLineRow.getAttribute("CurrTotQty"));
            certificaLineRow.setAttribute("CurrAmount_Trans", appLineRow.getAttribute("CurrAmount"));
            
            certificaLineRow.setAttribute("CumPerc_Trans", appLineRow.getAttribute("CumPerc"));
            certificaLineRow.setAttribute("CumSupOnlyQty_Trans", appLineRow.getAttribute("CumSupOnlyQty"));
            certificaLineRow.setAttribute("CumSupInsQty_Trans", appLineRow.getAttribute("CumSupInsQty"));
            certificaLineRow.setAttribute("CumAmount_Trans", appLineRow.getAttribute("CumTotQty"));
            certificaLineRow.setAttribute("CumTotQty_Trans", appLineRow.getAttribute("CumAmount"));
    ...
    public ViewObjectImpl getcertificationSearchROVO1() {
        ...
        //System.err.println("====="+ADFContext.getCurrent().getSessionScope().get("page")+"=====");
        ...
        if("add".equalsIgnoreCase((String)ADFContext.getCurrent().getSessionScope().get("addEditCert"))){
            ...
            if("certificationBuy".equalsIgnoreCase((String)ADFContext.getCurrent().getSessionScope().get("page"))||
               "certificationSell".equalsIgnoreCase((String)ADFContext.getCurrent().getSessionScope().get("page"))){
                //System.err.println("==CERT==PAGE ADD BUTTON=="+ADFContext.getCurrent().getSessionScope().get("page"));
                ADFContext.getCurrent().getPageFlowScope().put("resultVal", "NewButtonCertification");
            }
            else{
                //System.err.println("==CERT==PAGE ADD METHOD=="+ADFContext.getCurrent().getSessionScope().get("page"));
                ADFContext.getCurrent().getPageFlowScope().put("resultVal", "NewMethodCertification");
            }
                ...
                ADFContext.getCurrent().getPageFlowScope().put("resultVal", "EditCertification");
            }
    ...
    /**
     * Container's getter for getApprovalHsty_ROVO1.
     * @return getApprovalHsty_ROVO1
     */
    public ViewObjectImpl getgetApprovalHsty_ROVO1() {
        return (ViewObjectImpl)findViewObject("getApprovalHsty_ROVO1");
    }

    /**
     * Container's getter for CertHdr_GetApprovalHsty_VL1.
     * @return CertHdr_GetApprovalHsty_VL1
     */
    public ViewLinkImpl getCertHdr_GetApprovalHsty_VL1() {
        return (ViewLinkImpl)findViewLink("CertHdr_GetApprovalHsty_VL1");
    }

    /**
     * Container's getter for GetCertDetailsRoVo1.
     * @return GetCertDetailsRoVo1
     */
    public ViewObjectImpl getGetCertDetailsRoVo1() {
        return (ViewObjectImpl)findViewObject("GetCertDetailsRoVo1");
    }

    /**
     * Container's getter for CertContAppDtlsAprvMail_RoVo1.
     * @return CertContAppDtlsAprvMail_RoVo1
     */
    public ViewObjectImpl getCertContAppDtlsAprvMail_RoVo1() {
        return (ViewObjectImpl)findViewObject("CertContAppDtlsAprvMail_RoVo1");
    }
    ...
    /**
     * Container's getter for CertHdr_PoSaasAttch_VL1.
     * @return CertHdr_PoSaasAttch_VL1
     */
    public ViewLinkImpl getCertHdr_PoSaasAttch_VL1() {
        return (ViewLinkImpl)findViewLink("CertHdr_PoSaasAttch_VL1");
    }

    /**
     * Container's getter for Xxsc_AppHdrContHdrVersn_RoVo1.
     * @return Xxsc_AppHdrContHdrVersn_RoVo1
     */
    public ViewObjectImpl getXxsc_AppHdrContHdrVersn_RoVo1() {
        return (ViewObjectImpl)findViewObject("Xxsc_AppHdrContHdrVersn_RoVo1");
    }
    ...
    /**
     * Container's getter for CertHdr_XxscAtchment_VL1.
     * @return CertHdr_XxscAtchment_VL1
     */
    public ViewLinkImpl getCertHdr_XxscAtchment_VL1() {
        return (ViewLinkImpl)findViewLink("CertHdr_XxscAtchment_VL1");
    }

    /**
     * Container's getter for certificationtokenaccessrovo1.
     * @return certificationtokenaccessrovo1
     */
    public ViewObjectImpl getcertificationtokenaccessrovo1() {
        return (ViewObjectImpl)findViewObject("certificationtokenaccessrovo1");
    }

    /**
     * Container's getter for CertNumberManualInsertROVO1.
     * @return CertNumberManualInsertROVO1
     */
    public ViewObjectImpl getCertNumberManualInsertROVO1() {
        return (ViewObjectImpl)findViewObject("CertNumberManualInsertROVO1");
    }
}
